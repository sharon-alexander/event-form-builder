...
export default function AdvancedTab({ draft, update }: Props) {
  ...
  return (
    <section>
      <h2 className="text-sm font-semibold text-zinc-900">Tripleseat</h2>
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <div className="sm:col-span-2">
          <label className="adm-label" htmlFor="publicKey">
            Public key
          </label>
          <input
            id="publicKey"
        ...
        <div>
          <label className="adm-label" htmlFor="leadFormId">
            Lead form ID
          </label>
          <input
            id="leadFormId"
        ...
        <div>
          <label className="adm-label" htmlFor="locationId">
            Location ID
          </label>
          <input
            id="locationId"
        ...
        <div className="sm:col-span-2">
          <label className="adm-label" htmlFor="apiBaseUrl">
            API base URL
          </label>
          <p className="mb-1 text-xs text-zinc-400">
            Leave blank to use the default (<code className="text-zinc-500">https://api.tripleseat.com/v1</code>).
